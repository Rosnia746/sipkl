    ...
    <div class="card-body">
        <form action="{{ route('laporan.update', $item->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row" hidden>
                ...
                <div class="col">
                    <div class="form-group">
                        <input id="tempat_pkl_id" type="text"
                            class="form-control @error('tempat_pkl_id') is-invalid @enderror" name="tempat_pkl_id"
                            value="{{ Auth::user()->profile->tempat_pkl_id }}" autocomplete="tempat_pkl_id" autofocus
